...
public class ChooseTaskFragment extends Fragment {
    private final TaskHandler<ChooseTask> taskHandler;
    private int index;


    public ChooseTaskFragment(TaskHandler<ChooseTask> taskHandler, int index) {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ChooseTask task = taskHandler.tasks.get(index);
        ...
        nextTask.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((ReceiveFromFragment) getActivity()).receive(2, taskHandler, index + 1);
            }
        });
    }


    private void initTexts(TextView taskText, Button answer1, Button answer2, Button answer3, Button answer4, ChooseTask task) {
    ...
    private void actionOnClick(ChooseTask task, Button answer, Button answer1, Button nextTask, Button answer2, Button answer3, Button answer4) {
